...
return Column(children: [
  ...
  Row(children: [
    ...
    InputDecoration(border: OutlineInputBorder()), controller: bleMac,
  ...
  Row(children: [
    ...
    width:80,height:45, child: TextField(textAlign: TextAlign.center, decoration: 
      InputDecoration(border: OutlineInputBorder()), controller: loco1,
      style: TextStyle(fontSize:20)))),
    SizedBox(width:10),
  ...
  Row(children: [
    Padding(padding: EdgeInsets.all(10.0), child: Container(color: Colors.teal[50],
      width:80,height:45, child: TextField(textAlign: TextAlign.center, decoration: 
      InputDecoration(border: OutlineInputBorder()), controller: loco2,
      style: TextStyle(fontSize:20)))),
    SizedBox(width:10),
  ...
  Row(children: [
    Padding(padding: EdgeInsets.all(10.0), child: Container(color: Colors.teal[50],
      width:80,height:45, child: TextField(textAlign: TextAlign.center, decoration: 
      InputDecoration(border: OutlineInputBorder()), controller: loco3,
      style: TextStyle(fontSize:20)))),
    SizedBox(width:10),
